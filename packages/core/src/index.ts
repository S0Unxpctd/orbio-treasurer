...
// S-04: settle -> claim -> activate (gated, capped) — packages/core/src/chain/claim.ts.
// S-05: buyAndActivate (gated, capped) — packages/core/src/chain/buy.ts.
export type {
  ApiBalance,
  BuyCaps,
  BuyCreditDeps,
...
export {
  ...
  CLAIM_DEFAULT_MAX_FEE_GWEI,
  CLAIM_DEFAULT_MIN_GAS_ETH,
  ClaimExecutionError,
  capRemaining,
  claimAndActivate,
